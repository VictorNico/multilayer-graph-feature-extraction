...
\begin{center}
			...
			\Huge
			\textbf{\large{EXPOSÉ INFO5029 (SCIENCES DES DONNÉES):}\\ \Huge{Scalable and Accurate Test Case Prioritization in Continuous Integration Contexts\\ \large{Auteurs : \texttt{Ahmadreza Saboor Yaraghi et al}}}
}
  ...
  \vspace{1cm}
        ...
        \hfill \textbf{Superviseur:} Pr.  Norbert TSOPZE
