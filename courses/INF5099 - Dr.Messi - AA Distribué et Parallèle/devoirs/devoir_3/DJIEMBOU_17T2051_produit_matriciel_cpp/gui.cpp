...
void gui() {
    ...
    // string filename = "result_bloc_modulo"+currentDate+".csv";
    string filename = "result_bloc_modulo.csv";
    string filename_1 = "result_bloc_seq.csv";
    // string filename_1 = "result_bloc_sec"+currentDate+".csv";
    string filename_2 = "result_seq_modulo.csv";
    // string filename_2 = "result_sec_modulo_"+currentDate+".csv";
    string path = "outputs/"+filename;
    string path_1 = "outputs/"+filename_1;
    string path_2 = "outputs/"+filename_2;
    string line = "lines,bloc_time,modulo_time,n_thread";
    string line_1 = "lines,bloc_time,seq_time";
    string line_2 = "lines,seq_time,modulo_time";
    ...
    if (fileExists(path_1)) {
        cout << path_1 << " exists!" << endl;
    } else {
        write_csv(line_1, path_1);
    }
    if (fileExists(path_2)) {
        cout << path_2 << " exists!" << endl;
    } else {
        ...
        switch (ch) {
            ...
            case 7:{
                if (stages[2]){
                    ...
                    line_1 = to_string(Ncol1_row2)+","+to_string(elapsed2)+","+to_string(elapsed3);
                    write_csv(line_1, path_1);
                }
                else {
                    cout << "need 3)" << endl;
            ...
            case 8:{
                if (stages[2]){
                    ...
                    line_2 = to_string(Ncol1_row2)+","+to_string(elapsed3)+","+to_string(elapsed2);
                    write_csv(line_2, path_2);
                }
                else {
                    cout << "need 3)" << endl;
            ...
            case 9:{
                if (stages[2]){
                    ...
                    line = to_string(Ncol1_row2)+","+to_string(elapsed3)+","+to_string(elapsed2)+","+to_string(Nthread);
                    write_csv(line, path);
                }
                else {
                    cout << "need 3)" << endl;
