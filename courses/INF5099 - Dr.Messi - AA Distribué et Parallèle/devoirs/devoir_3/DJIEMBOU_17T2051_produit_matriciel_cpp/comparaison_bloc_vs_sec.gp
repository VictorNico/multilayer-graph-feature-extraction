...
set key outside
set output "outputs/bloc_vs_sec.png"
...
!sort -t "," -k1,1 -n -o outputs/sorted_data_2.csv "outputs/result_bloc_sec.csv"
...
plot str_sort using 1:2 with lines title "Bloc Approach", \
     str_sort using 1:3 with lines title "Sec Approach"