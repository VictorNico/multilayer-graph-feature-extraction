...
void gui() {
    ...
    do {
        ...
        printf("#   6 - Map Reduce Parallel Execution\n");
        printf("#   7 - Sequential Execution\n");
        printf("#   8 - Block Parallel and Sequential Execution\n");
        printf("#   9 - Modulo Parallel and Sequential Execution\n");
        printf("#   10 - Block Parallel and Modulo Parallel Execution\n");
        printf("#   11 - Block Parallel, Modulo Parallel, Map Reduce Parallel and Sequential Execution\n");
        printf("#   12 - Print clusters\n");
        printf("#   17 - Print clusters\n");
        ...
        switch (ch) {
            ...
            case 2:{
                ...
                for (int i = 0; i < _ThreadArgs.k; i++){
                    ...
                    _clusters[i].points = malloc(_ThreadArgs.dataSize*sizeof(Point));
                }
            ...
            case 3:{
                ...
                for (int i = 0; i<_ThreadArgs.k; i++) {
                    ...
                    for (int j = 0; j < _ThreadArgs.dim; j++) {
                        ...
                        // printf("b[%d][%d]:%f\n",i,j,_ThreadArgs.centroids_b[i].dim[j]);
                        // printf("m[%d][%d]:%f\n",i,j,_ThreadArgs.centroids_m[i].dim[j]);
                        // printf("mr[%d][%d]:%f\n",i,j,_ThreadArgs.centroids_mr[i].dim[j]);
                        // printf("c[%d][%d]:%f\n",i,j,_ThreadArgs.centroids[i].dim[j]);
                        // printf("----");
                    }
                }
            ...
            case 12:{
                ...
                do {
                    ...
                    printf(" 13 - Seq result\n");
                    printf(" 14 - Bloc result\n");
                    printf(" 15 - Modulo result\n");
                    printf(" 16 - Map Reduce result\n");
                    choose = get_integer();
                } while(choose <12 || choose >16);
                switch (choose) {
                    case 13:
