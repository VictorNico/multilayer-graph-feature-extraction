if __name__ == '__main__':
    ...
    if False:
        ...
        Max Information Gain Split: {max_information_gain_split(data['Attribute_1'], data['Class'], entropy)}
    ...
    data = process_file("data/GERMAN_preprocessed_2024_05_11_20_17_48.csv", ",", True)
