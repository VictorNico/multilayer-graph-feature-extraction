...
typedef struct {
    ...
    std::vector<std::vector<double>>* C; /** Result Matrix */
 ...
 * 
 */
void block_matrix_multiply_thread(ThreadArgs*  arg, std::mutex& mtx);
 ...
 * 
 */
void modulo_matrix_multiply_thread(ThreadArgs*  arg, std::mutex& mtx);
